                                            ...
                                            <div class="row collapse-body">
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="pro_area" name="pro_area" class="form-control form-control-sm selectpicker" data-container="body" data-size="10" data-live-search="true" data-style="border" required>
                                                            <option value="0" disabled>-- Seleccione --</option>
                                                        </select>
                                                    </div>
                                                </div>
                                ...
                                <table class="table table-striped table-hover">
                                    <thead class="text-center">
                                        <tr>
                                            <th>Acciones</th>
                                            <th>Nombres</th>
                                            <th class="sticky-table-column">Apellidos</th>
