...
?>
    ...
    <head>
        ...
        <title>Catalogo Tipo de Entalle - Manager Norton</title>
    </head>
    ...
    <body>
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <main class="p-1 p-md-3">
                        <section class="m-2">
                            <div class="text-left">
                                <h4>Gestor de Tipos de Entalle</h4>
                            </div>
                            <hr>
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">Nombre del Tipo de Entalle</span>
                                                            </div>
                                                            <input type="text" id="pro_nombre" name="pro_nombre" class="form-control" placeholder="ENTALLE" minlength="3" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
        ...
        <script src="<?= BASE ?>assets/js/adm_tipoentalle.js?v=<?= time(); ?>" type="text/javascript"></script>
    </body>
