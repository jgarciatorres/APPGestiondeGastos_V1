...
?>
    ...
    <head>
        ...
        <title>Catalogo Modelo - Manager Norton</title>
    </head>
    ...
    <body>
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">Nombre del Modelo</span>
                                                            </div>
                                                            <input type="text" id="pro_nombre" name="pro_nombre" class="form-control" placeholder="ADIAN FEST" minlength="3" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
        ...
        <script src="<?= BASE ?>assets/js/adm_modelo.js?v=<?= time(); ?>" type="text/javascript"></script>
    </body>
