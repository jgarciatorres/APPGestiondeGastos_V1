...
?>
    ...
    <head>
        ...
        <title>Catalogo Tipo de Bota - Manager Norton</title>
    </head>
    ...
    <body>
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">Nombre del Tipo de Bota</span>
                                                            </div>
                                                            <input type="text" id="pro_nombre" name="pro_nombre" class="form-control" placeholder="BOTA" minlength="3" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
        ...
        <script src="<?= BASE ?>assets/js/adm_tipobota.js?v=<?= time(); ?>" type="text/javascript"></script>
    </body>
